...
allocate_string(QxlHashTable *vm_global_strings, char* chars, int length, uint32_t hash) 
{
...
QxlObjectString* 
QxlObjectString_copy(QxlHashTable *vm_global_strings, const char *chars, int length)
{
    uint32_t hash = Qxl_hash_str(chars, length);

    QxlObjectString *interned = QxlHashTable_find_string(vm_global_strings, chars, length, hash);
...
// String Methods
QxlObjectString*
QxlString_concatenate(QxlHashTable *vm_global_strings, QxlObjectString *a, QxlObjectString *b)
{
